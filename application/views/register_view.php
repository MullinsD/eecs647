...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" action = "verifyregister" method = "post"  role="form">
		...
		<input type="text" class="form-control" placeholder="Affiliations" name ="affiliation" required autofocus>
